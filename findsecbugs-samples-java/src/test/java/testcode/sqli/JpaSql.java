...
public class JpaSql {
    ...
    public static class JakartaJpaSql {
        ...
        public void getUserByUsername(String username) {
            jakarta.persistence.TypedQuery<UserEntity> q = em.createQuery(
                    String.format("select * from Users where name = %s", username),
                    UserEntity.class);
        ...
        public UserEntity getFirstAlt2() {
            final String sql = "select * from Users";
            jakarta.persistence.TypedQuery<UserEntity> q = (jakarta.persistence.TypedQuery<UserEntity>) em.createQuery(sql);
            return q.getSingleResult();
        }
