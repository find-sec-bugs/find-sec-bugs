...
public class UnencryptedSocketDetector extends OpcodeStackDetector {
    ...
    public void sawOpcode(int seen) {
        ...
        if (seen == INVOKESPECIAL && getClassConstantOperand().equals("java/net/Socket") &&
            ...
            bugReporter.reportBug(new BugInstance(this, UNENCRYPTED_SOCKET_TYPE, NORMAL_PRIORITY) //
